    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            var defaults = {
                ...
                spinner : 'spinner-pulse', // available: 'rotating-plane' | 'double-bounce' | 'wave' | 'wandering-cubes' | 'spinner-pulse' | 'chasing-dots' | 'three-bounce' | 'circle' | 'cube-grid' | 'fading-circle' | 'folding-cube'
                spinColor : '#d2d2d2',
                titleattr: 'data-title', // specific attribute to get a title (e.g. [data-title]) - thanx @mendezcode
                titleBackground: '#161617',
                titleColor: '#d2d2d2',
                titlePosition : 'top', // 'top' || 'bottom'
                share: ['linkedin', 'pinterest', 'facebook', 'twitter', 'download'], // ['facebook', 'twitter', 'linkedin', 'pinterest', 'download']
